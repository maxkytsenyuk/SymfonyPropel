...
namespace authentication\AuthBundle\Model\om;
...
use authentication\AuthBundle\Model\UsersPeer;
use authentication\AuthBundle\Model\map\UsersTableMap;
...
abstract class BaseUsersPeer
{
    ...
    const OM_CLASS = 'authentication\\AuthBundle\\Model\\Users';

    /** the related TableMap class for this table */
    const TM_CLASS = 'authentication\\AuthBundle\\Model\\map\\UsersTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID, UsersPeer::USERNAME, UsersPeer::EMAIL, UsersPeer::PASSWORD, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID => 0, UsersPeer::USERNAME => 1, UsersPeer::EMAIL => 2, UsersPeer::PASSWORD => 3, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUsersPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \authentication\AuthBundle\Model\map\UsersTableMap());
      }
    }
